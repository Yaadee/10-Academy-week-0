...
# st.set_page_config(page_title="MoonEnergy Solar Installation", page_icon=":sun_with_face:", layout="wide", initial_sidebar_state="expanded")
...
# st.sidebar.image("tests/th.jpeg", use_column_width=True)
